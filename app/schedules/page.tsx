...
import { SchedulesView } from "@/components/nurse/schedules-view"
...
export default function SchedulesPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-lg">Loading schedules...</span>
        </div>
      </div>
    )
  }
  ...
  // Create user object compatible with SchedulesView
  const userData = {
  ...
  return <SchedulesView user={userData} />
}
